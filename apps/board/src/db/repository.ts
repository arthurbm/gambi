...
import { prepareTileArtifact } from "../tile-artifacts";
...
import { TileRepository, type TileVersionView } from "./tile-repository";

export type { TileVersionView } from "./tile-repository";
...
export class BoardRepository {
  ...
  constructor(db: BoardDatabase) {
    this.db = db;
    this.tileRepository = new TileRepository(db);
  }
  ...
  listTileVersions(squad?: string): Promise<TileVersionView[]> {
    return this.tileRepository.listVersions(squad);
  }

  listLiveTiles() {
    return this.tileRepository.listLive();
  }

  getLiveTileDocument(squad: string) {
    return this.tileRepository.getLiveDocument(squad);
  }
