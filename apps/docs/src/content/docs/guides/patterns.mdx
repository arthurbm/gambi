...
Six patterns for building experiences where multiple LLMs collaborate. Each one is a few lines of TypeScript on top of the [Gambi SDK](/reference/sdk/). Gambi handles room routing, event streams, and participants from several machines.
